...
import { Building, UserPlus, FileText, Coins } from 'lucide-react';
    ...
    <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
      ...
      <div className="border rounded-lg p-4 bg-amber-50 border-amber-100">
        ...
        {isLoading ? (
          ...
          <>
            <div className="text-3xl font-bold text-amber-700">{dashboardStats?.newSubsidiesThisMonth || '0M'} FCFA</div>
