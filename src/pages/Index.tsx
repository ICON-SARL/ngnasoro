...
const Index = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-[#f8fafc] to-white dark:from-gray-950 dark:to-gray-900">
      ...
      {/* SFD Account Request Section */}
      <section className="py-16 md:py-24 bg-white dark:bg-gray-900">
        <div className="container mx-auto px-4 md:px-6">
          <div className="text-center space-y-4 mb-12">
            <Badge className="bg-[#0D6A51]/10 text-[#0D6A51] border-[#0D6A51]/20">
              Devenir Partenaire SFD
            </Badge>
            <h2 className="text-3xl md:text-4xl font-bold">
              Rejoignez le réseau N'GNA SÔRÔ!
            </h2>
            <p className="text-lg text-gray-600 dark:text-gray-300 max-w-2xl mx-auto">
              Vous êtes une institution de microfinance ? Demandez un compte administrateur SFD pour accéder à notre plateforme.
            </p>
          </div>
